...
const App = () => {
 ...
 }; const affTrash = () => window.location.href = '/trash';const affToday = () => window.location.href = '/today';
     ...
     <div className="page">
       <div className="main-left">
         <div className="barre">
           ...
           {/* <h3 onClick={affTrash}>Important</h3> */}
           <h3 onClick={() => affToday()}>Today</h3>
           <h3>Important</h3>
           <h3 onClick={() => affTrash()}>Corbeille</h3>
         </div>
       </div>
       <div className="main-right">
         ...
         <div className="main">
           {window.location.pathname === '/todolist' ? <TodoList /> :window.location.pathname === '/trash' ? <Trash />:window.location.pathname === '/today' ? <Today />: null}
